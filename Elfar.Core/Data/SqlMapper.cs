namespace Elfar.Data
{
    ...
    public static class SqlMapper
    {
        ...
        /// </summary>
        public static IEnumerable<dynamic> Query(this IDbConnection cnn, string sql, dynamic param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null)
        {
        ...
        /// </returns>
        public static IList<T> Query<T>(this IDbConnection cnn, string sql, dynamic param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null)
        {
            return QueryInternal<T>(cnn, sql, param as object, transaction, commandTimeout, commandType).ToList();
        }
        ...
        private static Func<IDataReader, object>[] GenerateDeserializers(Type[] types, string splitOn, IDataReader reader)
        {
            ...
            Func<Type, int> nextSplit = type =>
            {
                ...
                if(type != typeof(Object))
                {
                    ...
                    if(props.Select(p => p.Name).Concat(fields.Select(f => f.Name)).Any(name => string.Equals(name, currentSplit, StringComparison.OrdinalIgnoreCase)))
                    {
                        skipFirst = true;
                        startingPos = current;
                    }
        ...
        private static Func<IDataReader, object> GetDynamicDeserializer(IDataRecord reader, int startBound, int length, bool returnNullIfFirstMissing)
        {
            ...
            {
                throw new ArgumentException("When using the multi-mapping APIs ensure you set the 'startBound' param if you have keys other than Id", "startBound");
            }
...
#pragma warning restore 618
        ...
        public class GridReader : IDisposable
        {
            ...
            public IEnumerable<T> Read<T>()
            {
                ...
                consumed = true;
                return ReadDeferred<T>(gridIndex, deserializer, deserializerGenerator);
            }
            ...
            private IEnumerable<TReturn> MultiReadInternal<TFirst, TSecond, TThird, TFourth, TFifth, TReturn>(object func, string splitOn)
            {
                ...
                try
                {
                    foreach(var r in MultiMapImpl<TFirst, TSecond, TThird, TFourth, TFifth, TReturn>(null, null, func, null, null, splitOn, null, null, reader, identity))
                    {
                        yield return r;
                    }
                }
